    ...
    if(data_frwd ==1):
        ...
        if(instr_type=="R" or instr_type=="SB"):
            if(variable["rs1"]!=variable["rs2"]):
                ...
                if(registers_bool[int("0b"+variable["rs2"],2)] ==2):
...
def print_stmt():
    ...
    stats=["Total number of cycles: "+str(number_of_cycles), "Total instructions executed: "+str(number_of_instrs), "CPI: "+str(number_of_cycles/number_of_instrs),"Number of Data-transfer (load and store) instructions executed: "+str(number_of_load_store),
